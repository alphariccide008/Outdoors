    ...
    <>
        <div className="items-center py-7">
            <div className='md:flex hidden mx-[13%] '>
                <div className='w-1/2 text-[24px] text-end pb-3 pt-2'>Clients that trusts Us</div>
                <div className='w-1/2 text-end'>
                    <Link to='' className='underline text-[14px] text-[#0A6535]'style={{fontSize:'13px'}}>Click to View All</Link>
                </div>
            </div>
           ...
           <div className=' mx-[13%] md:hidden '>
                <div className='text-[14px]  text-center pb-3 pt-2'>Clients that trusts Us</div>
