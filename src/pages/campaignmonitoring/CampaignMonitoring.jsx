  ...
  return (
    ...
    <div className="monitoring-banner">
      <div className='text-center md:pt-[18%] pt-[40%] lg:mx-[20%]'>
         ...
         <p className='text-[18px] text-[#B0B0B0] px-2 pb-5'>A well-constructed billboard is the foundation of outdoor advertising success. Outdoors.ng provides expert construction and maintenance services to ensure your brand’s message is always visible and impactful.</p>
