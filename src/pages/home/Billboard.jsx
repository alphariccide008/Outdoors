               ...
               <form action="">
                <div className="flex mb-3">
                    <div className="flex-col my-2 w-1/2 text-start">
                        ...
                        <select name="" className="border px-[25%] bg-[#E6E6E6] mr-1 py-[4%] rounded-xl" id="" style={{fontSize:'12px'}}>
                            <option value="" >Select Type</option>
                        </select>
                    </div>
                    <div className="w-1/2 my-2 text-start">
                    <label htmlFor="" className="font-semibold" style={{fontSize:'13px'}}>Select Type</label><br />
                        <select name="" id="" className="border bg-[#E6E6E6] ml-1 rounded-xl  px-[25%] py-[4%]" style={{fontSize:'12px'}}>
