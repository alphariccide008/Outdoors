...
const OrderForDeployment = () => {
  return (
    <>
    <div className="deploy-banner">
      <div className='text-center md:pt-[18%] pt-[25%] lg:mx-[20%]'>
         <h1 className='text-[37px]  font-semibold text-[#D9D9D9] pb-5'>Deployment That Delivers Results</h1>
         <p className='text-[18px] text-[#B0B0B0] px-2 pb-5'>At Outdoors.ng, we ensure your advertising campaign goes live without a hitch. From logistics planning to on-ground execution, we manage every aspect of deployment to ensure your brand’s message reaches its audience on time.</p>
...
export default OrderForDeployment