import './OrderForInstallation.css'
...
const OrderForInstallation = () => {
  return (
    <>
    <div className="install-banner">
      <div className='text-center md:pt-[18%] pt-[25%] lg:mx-[20%]'>
         <h1 className='text-[37px]  font-semibold text-[#D9D9D9] pb-5'>Installation Done Right, Every Time</h1>
         <p className='text-[18px] text-[#B0B0B0] px-2 pb-5'>At Outdoors.ng, we know that installation is as important as design. A poorly installed ad can harm your brand’s image, which is why our team ensures every installation is flawless, secure, and optimized for visibility.</p>
...
export default OrderForInstallation