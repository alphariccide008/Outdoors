  ...
  return (
    ...
    <div className="paid-banner">
      <div className='text-center md:pt-[18%] pt-[40%] lg:mx-[20%]'>
         <h1 className='text-[37px]  font-semibold text-[#D9D9D9]  pb-5'>Outdoor Advertising, Monitored for Success</h1>
         <p className='text-[18px] text-[#B0B0B0] px-2 pb-5'>Trust is key in outdoor advertising. With Outdoors.ng’s paid monitoring services, you can be confident that your campaigns are executed flawlessly and delivering the desired results.</p>
